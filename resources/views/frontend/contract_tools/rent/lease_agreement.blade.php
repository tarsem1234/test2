        ...
        <div class="">
            ...
            <div class="col-md-9 col-sm-8">
                    ...
                    <div class="para-text row">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Address:</label>
                                    <textarea id="formatted_address" class="form-control" name="address" readonly="readonly">{{($offer->property->street_address??"") . ((isset($offer->property->townhouse_apt) && $offer->property->townhouse_apt) ? " Apt# ".$offer->property->townhouse_apt :"")}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label>City:</label>
				...
				foreach ($landlordPartners as $landlordPartner) {
				    $getusers = App\Models\Access\User\User::where('id', $landlordPartner)->with('user_profile')->first();
//                                    dd($getusers);die;
				    ?>
				    <div class="col-md-12">
					<h5>LANDLORD</h5>
					...
					<div class="form-group">
					    <label>Street Address:</label>
					    <textarea id="formatted_address" class="form-control" placeholder="Address" readonly="readonly">{{$getusers->user_profile->address??$offer->landlord->business_profile->company_address??""}}</textarea>
					</div>
					<div class="form-group">
					    <label>City:</label>
					    <input id="city" class="form-control" type="text" value="{{ $getusers->city??"" }}" readonly="readonly">
					</div>

					<div class="form-group">
					    <label>State:</label>
					    <input id="state" class="form-control" value="<?php echo findState($getusers->state_id); ?>" type="text" readonly="readonly">
					</div>
					<div class="form-group">
					    <label>Zip Code:</label>
					    <input id="postal_code" class="form-control" min="0" type="number" value="{{$getusers->zip_code??"" }}" readonly="readonly">
					</div>
					<div class="form-group">
					    <label>Telephone:</label>
					    <input type="text" class="form-control" id="inputEmail3" value="{{$getusers->phone_no??''}}" readonly="readonly">
					</div>
					<p>(Collectively and individually the 'Landlord')</p>
				    </div>
				    <?php
			    ...
			    ?>
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label>Zip Code:</label>
                                    <input id="postal_code" class="form-control" min="0" placeholder="Zip Code" value="{{$offer->tenant->zip_code??''}}" type="number" value="" autocomplete="off" readonly="readonly">
                                </div>
                                <div class="form-group">
                                    <label>Telephone:</label>
			    ...
			    <?php
			    if (isset($offer->tenantQuestionnaire->partners) && $offer->tenantQuestionnaire->partners) {
				$tenantPartners = explode(',', $offer->tenantQuestionnaire->partners);
				foreach ($tenantPartners as $tenantPartner) {
				    $getusers = App\Models\Access\User\User::where('id', $tenantPartner)->with('user_profile')->first();
				    ?>
				    <div class="col-md-12">
					<h5>CO-SIGNER</h5>
					<div class="form-group">
					...
					<div class="form-group">
					    <label>Street Address:</label>
					    <textarea class="form-control" readonly="readonly">{{$getusers->user_profile->address ?? $getusers->business_profile->company_address ?? ""}}</textarea>
					</div>
					<div class="form-group">
					    <label>City:</label>
					    <input class="form-control" readonly="readonly" value="{{$getusers->city??''}}">
					</div>
					<div class="form-group">
	                                    <label>State:</label>
	                                    <input id="state" class="form-control" placeholder="State" value="<?php echo findState($getusers->state_id); ?>" type="text" readonly="readonly">
	                                </div>
	                                <div class="form-group">
	                                    <label>Zip Code:</label>
	                                    <input id="postal_code" class="form-control" min="0" placeholder="Zip Code" value="{{$getusers->zip_code??''}}" type="number" value="" autocomplete="off" readonly="readonly">
	                                </div>
	                                <div class="form-group">
	                                    <label>Telephone:</label>
	                                    <input type="text" class="form-control" value="{{$getusers->phone_no??''}}" readonly="readonly">
	                                </div>
			    ...
			    ?>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea rows="12" type="text" class="form-control text-height" id="" name="furnishings" readonly="readonly">{{$offer->landlordQuestionnaire->furnishings??""}}</textarea>
			...
			if (!empty($offer->rent_counter_offers->first()->counter_offer_price)) {
			    $updatedPurchasePrice = $offer->rent_counter_offers->first()->counter_offer_price;
			} else {
			    $updatedPurchasePrice = $offer->rent_price ?? "";
			}
			?>
				    <div class="form-group">
                      <div class="col-md-12">
				      ...
				      <span class="text-readonly"><input type="text" class="readonly" id="text-form-input" name="" value="${{$updatedPurchasePrice}}" readonly="readonly"></span>
				      per month (collectively the 'Rent').The Tenant will pay the Rent on or before the 5th day of each and every month.</p>
					</div><!--col-md-12-->
				    </div>
				    <div class="form-group">
					<div class="col-md-12">
						...
						<span class="text-readonly"><input type="text" class="readonly" id="text-form-input" name="" value="{{$offer->landlordQuestionnaire->security_deposit??""}}" readonly="readonly"></span>
					...
					<div class="col-md-12">
						...
						<span class="text-readonly"><input type="text" class="custom_state" id="text-form-input" name="custom_state" value="<?php echo findState($offer->property->state_id);?>" readonly="readonly"></span>,without regard to the jurisdiction in which any action or special proceeding may be instituted.</p>
					</div>
				    </div>
				    <div class="form-group">
					<div class="col-md-12">
					...
					<div class="col-md-12">
					    ...
					    <p>The Landlord will provide the following utilities to the tenant at the landlord's expense:</p>
					    <textarea rows="12" type="text" class="form-control text-height" id="" name="expense" readonly="readonly" placeholder="expense">{{$offer->landlordQuestionnaire->utilities??""}}</textarea>
					</div>
				    </div>
				    <div class="form-group">
					<div class="col-md-12">
