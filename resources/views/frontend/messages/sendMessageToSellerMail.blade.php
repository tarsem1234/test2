                                ...
                                <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                            ...
                                            <br>
                                            <p>Hi <strong></strong>{{$userName}}, </p>
                                            <p>You have received a new message from {{$senderName}}. </p>
                                            <p>{{ $sellerMessage }}</p>
                                            <p> For replying to this message please go to Your Frezylist Inbox or click on following link. <a href="{{ $conversationLInk }}"> Conversation Link</a></p>
                                            <br>
                                            <br>
                                            <p> Thank You!</p>
                                            <br>
