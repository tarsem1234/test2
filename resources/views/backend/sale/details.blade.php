...
<div class="row">
    <div class="panel panel-default" class="table_main" style="padding:10px 50px 0 50px;overflow: hidden;">
        ...
        <span class="bld"><b>{{ isset($details->townhouse_apt) ? $details->townhouse_apt : $notAvailable }}: </b></span>
        <span>{{ isset($details->street_address) ? $details->street_address :$notAvailable }}</span>
        <hr>
        ...
        <div class="">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="bld"><b>Price : </b><span class="money">@if($details->price){{$details->price}} @else {{ $notAvailable }} @endif </span></h4>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active in" style="padding-bottom: 10px;" id="settings-pills">
                        ...
                        <br>
                        <?php if($isPropertyConditionDisclaimer > 0) { ?>
                        <a href="{{route('frontend.propertyDisclaimerPdf',$details->id)}}" target="_blank" style="text-align: left; margin:10px; margin-bottom:0" class="btn btn-info">View Disclosure</a>
                        <?php } ?>
                        <?php if($isLeadBasedPaintHazards > 0) { ?>
                        <a href="{{route('frontend.leadBasedPaintHazardsPdf',$details->id)}}" target="_blank" style="text-align: left; margin:10px; margin-bottom:0" class="btn btn-info">VIEW LEAD-BASED PAINT HAZARDS</a>
                        <?php } ?>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="{{ route('admin.saleIndex') }}"><button type="button" class="btn btn-primary">Back</button></a><br><br>
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset("js/backend.js?id=8f04b57585693f409f4d") }}"></script>
