...
<div class="box box-success">
    <div class="box-header with-border">
        <h3 class="box-title">{{ trans('labels.backend.access.users.admin_create') }}</h3>
...
<div class="box box-info">
    <div class="box-body">
        ...
        <div class="pull-right">
            <button type="submit" name="submit" class="btn btn-success btn-xs" value="Administrator">{{trans('buttons.general.crud.create')}}</button>
        </div><!--pull-right-->
