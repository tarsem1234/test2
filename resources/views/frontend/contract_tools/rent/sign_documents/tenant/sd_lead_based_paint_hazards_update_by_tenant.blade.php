                    ...
                    <div class="para-text row">
                        ...
                        <div class="form-group para-text">
                            <div class="col-md-12">
                                ...
                                if (isset($offer->property->lead_based) && ($offer->property->lead_based)
                                ...
                                if (isset($offer->property->lead_based_report) && ($offer->property->lead_based_report)
                                    == config('constant.inverse_common_yes_no.Yes')) {
                                    ?>
                                           checked="checked"
                                       <?php } ?> disabled="disabled" value="{{config('constant.inverse_common_yes_no.Yes')}}">
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-12">
                                ...
                                if (isset($offer->opportunity) && $offer->opportunity
                                    && $offer->opportunity == config('constant.inverse_lead_opportunity.10-day opportunity')) {
                                    ?>
                                           checked="checked"
                                           <?php
                                       }
                                ...
                                if (isset($offer->opportunity) && $offer->opportunity
                                    && $offer->opportunity == config('constant.inverse_lead_opportunity.Waived the opportunity')) {
                                    ?>
                                           checked="checked"
                                           <?php
                                       }
                        ...
                        <div class="btns-green-blue col-lg-12">
                            <a href="{{ route('frontend.sdThankYouTenantNecessaryForms') }}" id="ad_buyer_update"  class="button btn btn-green">Submit</a>
                        </div><!--</btns-green-blue>-->
                    </div>
                </div>
            </div><!--</col>-->
...
<script>
    ...
    function addSignature(id){
            $.ajax({
                type: "post",
                url: "{{ route('frontend.leadBasedSignatureRent') }}",
                data: {
                    id: id,
                },
