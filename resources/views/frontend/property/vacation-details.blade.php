...
<meta property="og:description" content="@if($vacation->property_description){{ $vacation->property_description }} @else {{ $notAvailable }} @endif " />
			...
			<div class="col-lg-6 col-md-12 left-div table-responsive">
				...
				<table class="table" id="detail-inner-table" style="width:100%; float:left;">
					...
					<tr class="">
					    ...
					    <td>{{ config('constant.available_weeks.'.$vacation->availableWeeks->first()->checkin_day)??"NA" }}</td>
					</tr>
				    </tbody>
				</table>
			    </div>
