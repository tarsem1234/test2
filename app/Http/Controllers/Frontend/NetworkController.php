...
class NetworkController extends Controller
{
    ...
    private function _searchedNetwork(Request $request, $userType, $viewPage)
    {
        ...
        } else if ($request->state && $request->zip && !$request->radius) {
    ...
    public function userDetails(Request $request, $id)
    {
        if ($id != Auth::id()) {
            ...
            if (!empty($user)) {
                ...
                return view('frontend.network_portal.user_details', compact('user', 'network', 'allowedToRate', 'userRating', 'recommended', 'recommendations'));
            }
        }
