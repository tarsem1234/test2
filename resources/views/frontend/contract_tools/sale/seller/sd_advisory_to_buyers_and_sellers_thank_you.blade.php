...
@section ('title', ('Sd Thankyou Purchase Agreement By Seller'))
        ...
        <div class=""> 
            ...
            <div class="col-md-9 col-sm-8">
               ...
               <div class="para-text">
                  ...
                  <h5>* FREEZYLIST is not responsible for inadequate disclosures. State disclosure requirements are not standardized and may vary; please consult your closing attorney to ensure you are in compliance with all required and recommended disclosure requirements.* </h5>
               </div>
                    <div class="btns-green-blue">
                        <a href="{{route('frontend.sdDisclosureBySellerUpdate')}}" class="btn btn-blue">Next</a>
                    </div><!--</btns-green-blue>-->
                </div>
            </div>
        </div><!--</col>-->
