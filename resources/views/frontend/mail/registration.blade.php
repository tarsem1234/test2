                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        @endforeach
                                        @if(isset($actionView)|| isset($actionText))
                                            <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <tr> 
                                                    <td align="left">
                                                        ...
                                                        ?>
                                                    @if (isset($actionView) && !empty($actionView['property_id']))
                                                        <a href="{{ $actionView['url'] }}"
                                                            style="{{ $fontFamily }} {{ $style['button'] }} background-color:#92c800; margin-right:10px;"
                                                            class="button"
                                                            target="_blank">
                                                            {{ $actionView['name'] }}
                                                        </a>
