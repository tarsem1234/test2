...
Breadcrumbs::for('admin.access.role.index', function ($breadcrumbs) {
    $breadcrumbs->parent('admin.dashboard');
    $breadcrumbs->push(trans('menus.backend.access.roles.management'), route('admin.access.role.index'));
});

Breadcrumbs::for('admin.access.role.create', function ($breadcrumbs) {
...
Breadcrumbs::for('admin.access.role.edit', function ($breadcrumbs, $id) {
    $breadcrumbs->parent('admin.access.role.index');
