...
<div class="container">
    <div class="row offers-page">
        <div class="col-lg-12">
            <div class=""> <h4>RECEIVED FROM :: {{ isset($offer->landlord->business_profile->company_name) ? $offer->landlord->business_profile->company_name : (isset($offer->tenant->user_profile->full_name) ? $offer->tenant->user_profile->full_name:"NA") }}</h4></div>
