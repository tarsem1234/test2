...
<div class="row">
    <div id="owl-carousel" class="owl-carousel owl-theme owl-loaded owl-drag" >
        <div class="item properties-for-vacation-bg-img ">
            <img src="{{ asset('/storage/site-images/vacation.jpg') }}" class="img-responsive" />
            <div class="text-heading">
                <a>
                    <h1 class="vacation-heading">Properties For Vacation</h1>
                    <p class="vacation-para">Listings Will Help You <span>Relax!</span></p>
                </a>
            </div>
        </div>
        <div class="item properties-for-vacation-bg-img ">
...
<div class="container explore-our-listings">
    <div class="col-md-12 btns-green-blue">
        <a href="{{route('frontend.vacationSearch')}}" class="btn btn-lg btn-green">Explore our Listings</a>
        <a href="{{route('frontend.vacationCreate')}}" class="btn btn-lg btn-blue">List Your Property</a>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs nav-tabs-responsive text-center" role="tablist">       
                ...
                <a href="#vacation" class="btn btn-sm btn-main active" role="tab" id="vacation-tab" data-toggle="tab" aria-controls="vacation">
            ...
            <div id="myTabContent" class="tab-content">
                        ...
                        if (isset($rentProperties) && count($rentProperties) > 0) {
                            foreach ($rentProperties as $rentProperty) {
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    <a href="{{'frontend.propertyDetails',$rentProperty->id}}">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
                                            <h4><span class="money">{{ $rentProperty->price }}</span></h4>
                                            <p>{{ findState($rentProperty->state_id) }}</p>
                        ...
                        if (isset($saleProperties) && count($saleProperties) > 0) {
                            foreach ($saleProperties as $saleProperty) {
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
                                            <h4><span class="money">{{ $saleProperty->price }}</span></h4>
                                            <p>{{ findState($saleProperty->state_id) }}</p>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="vacation" aria-labelledby="vacation-tab">
                    <div class="row  mx-0">
                        <?php
                        if (isset($vacationProperties) && count($vacationProperties) > 0) {
                            foreach ($vacationProperties as $vacationProperty) {
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
					     <h4><span class="money">{{ $vacationProperty->price }}</span></h4>
    ...
    $(function () {
        ...
        $('.form-we-help-you').validate({
            ...
            messages: {
                ...
                comment: "Please share your views"
            }
        });
