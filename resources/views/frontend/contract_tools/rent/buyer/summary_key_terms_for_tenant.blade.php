...
<div class="offers-page summary"> 
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                @else
                                <td> <p><strong>Rent/Month :</strong> <span class="money">{{round($offer->rent_price)}} </span></p></td>
                                @endif
                            </tr>
  ...
  @php
			    ...
			    $tenantFullName = $offer->tenant->business_profile->company_name??"";
                            ...
                            <tr>
                                <td><p><strong>Security Deposit Required :</strong> <span class="money">{{round($offer->landlordQuestionnaire->security_deposit)??"NA"}}</span></p></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><p><strong>Contingency  :</strong><span> NA</span></p></td>
                            </tr>
                            <tr>
