...
<p>- Anthony Rappa</p>',
    ...
    'emails' => [
        'auth' => [
            ...
            'click_to_login' => 'Click here to login your account:',
            'click_to_register' => 'Click here to register your account:',
        ],
    ...
    'frontend' => [
        ...
        'property' => [
            'sale' => [
                'stipulationFixedA' => 'Closing Cost Assistance from Seller to Buyer: Up to $:value.',
                'stipulationPercentageA' => "Closing Cost Assistance from Seller to Buyer: 'Up to :value% of Sales Price'.",
                'stipulationB' => 'The property is subject to a lease, or is expected to be occupied until :value. Physical possession of the property will not be available (to the Buyer) until after the date listed here. Further, this agreement may be subject to a Sale-Leaseback agreement or an Occupancy Agreement- If you agree to the date of possession, please consult with an attorney on these secondary agreements.',
            ],
            'rent' => [
                'pets' => 'A reasonable number of pets or animals are allowed to be kept in or about the Premises. If this privilege is abused, the Landlord may revoke this privilege upon thirty (30) days notice. The animals that may be permitted are as follows: Dog/Cat- Non-refundable Pet fee of $500. Any other pets must be given written consent by the landlord before being kept on the premises.',
            ],
        ],
    ],
];
