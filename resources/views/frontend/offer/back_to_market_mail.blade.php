                                ...
                                <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                            ...
                                            <p>Your listing is deactivated and no longer available in the market due to no activity on it from last 30 days. If you still wish it to be available in the market please open your listing page and press "back to the market" button.
                                            </p>
