    ...
    <main>
        ...
        <div class="form-group">
            <div class="col-md-12" style="width:100%;"> 
               ...
               <span class="margin-left" style="width:900px; float: right;">  
                <input type="radio"  disabled="disabled" <?php
                if (isset($property->disclosure->occupy)) {
     ...
     <div style="clear:both"></div>    
        ...
        <div id="seller">
            <div class="form-group">
                ...
                <div>
                    <textarea type="text"  class="form-control text-height" style="height:120px; margin-bottom:20px;" disabled="disabled">{{$property->disclosure->best_knowledge_explain??""}} </textarea>
                </div>
            </div>
        </div>
        <div class="form-group">
