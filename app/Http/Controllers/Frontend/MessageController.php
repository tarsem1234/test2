...
class MessageController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($messages as $message) {
            if (!in_array($message->user_id, $conversationWith) && $message->user_id != Auth::id()) $conversationWith[] = $message->user_id;
            if (!in_array($message->to_user_id, $conversationWith) && $message->to_user_id != Auth::id()) $conversationWith[] = $message->to_user_id;
        }
        $messages = collect();
