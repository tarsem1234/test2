...
class AddForeignKeysToQuestionsSellerTable extends Migration {
	...
	public function up()
	{
		Schema::table('questions_seller', function(Blueprint $table)
		{
			...
			$table->foreign('offer_id', 'questions_seller_ibfk_3')->references('id')->on('sale_offers')->onUpdate('RESTRICT')->onDelete('CASCADE');
		});
	}
	...
	public function down()
	{
		Schema::table('questions_seller', function(Blueprint $table)
		{
			...
			$table->dropForeign('questions_seller_ibfk_3');
		});
	}
