            ...
            <div class="col-md-9 col-sm-8">
                <div class="nested-div">
                    ...
                    <div class="btns-green-blue">
                        <a href="{{route('frontend.sdLeadBasedPaintHazardsDisclosureForRentByTenant')}}" class="btn btn-blue">Next</a>
                    </div><!--</btns-green-blue>-->
                    @else
                    <div class="heading-text">
                    ...
                    <div class="btns-green-blue">
                        <a href="{{route('frontend.sdDisclosuresRentTenant')}}" class="btn btn-blue">Next</a> 
                    </div><!--</btns-green-blue>-->
                    @endif
                </div>
            </div>
