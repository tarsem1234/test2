      ...
      <div class=""> 
         ...
         <div class="col-md-9 col-sm-8">   
            <div class="nested-div register-page"> 
               ...
               <div class="para-text row first-child">                         
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <p><b>7.</b> Rent shall be at the rate of $
                           ...
                           per day for the Term of the occupancy, payable in advance at Closing and delivery of deed. Should Seller vacate earlier, the unearned rent:

                           <input type="radio" id="will" value=""
                           <?php
                           ...
                           <input type="radio" id="will-not" value=""
                           <?php
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        ...
                        <p><b>8.</b> Should Seller not timely surrender possession of the Property to Buyer, Seller shall be subject to eviction and shall be additionally liable to Buyer for payment of $  
                           <span class="text-readonly">
                              <input type="text" class="readonly" id="text-form-input" name="perday" value="{{isset($additional_charge)?round($additional_charge):""}}" readonly="readonly">
                           </span>
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        ...
                        <p><b>9.</b> Water and sewer charges incurred during Seller's occupancy shall be paid by:<br>
                           <input type="radio" id="incurred yes" name=""
                           <?php
                           if (isset($savedQuestionSellerPostClosing) && $savedQuestionSellerPostClosing->utilities == config('constant.inverse_common_yes_no.Yes')) {
                              ?>
                                     checked="checked" <?php } ?> value="incurred Seller" disabled="disabled">
                           <label for="incurred yes">Seller</label>
                           <input type="radio" id="incurred no" name=""
                           <?php
                           if (isset($savedQuestionSellerPostClosing) && $savedQuestionSellerPostClosing->utilities == config('constant.inverse_common_yes_no.No')) {
                              ?>
                                     checked="checked" <?php } ?> value="incurred Buyer" disabled="disabled">
                           <label for="incurred no">Buyer</label></p>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <p><b>10.</b> Electric and gas service incurred during Seller's occupancy shall be paid by:<br>
                           <input type="radio" id="electricpaidbyyes" name="electricpaidby"
                           <?php
                           if (isset($savedQuestionSellerPostClosing) && $savedQuestionSellerPostClosing->utilities == config('constant.inverse_common_yes_no.Yes')) {
                              ?>
                                     checked="checked" <?php } ?> value="Seller" disabled="disabled">
                           <label for="electricpaidbyyes">Seller</label>
                           <input type="radio" id="electricpaidbyno" name="electricpaidby"
                           <?php
                           if (isset($savedQuestionSellerPostClosing) && $savedQuestionSellerPostClosing->utilities == config('constant.inverse_common_yes_no.No')) {
                              ?>
                                     checked="checked" <?php } ?> value="Buyer" disabled="disabled">
                           <label for="electricpaidbyno">Buyer  </label>
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        <p><b>11. </b>
                           <input type="radio" id="payBuyer" name=""
                           <?php
                     ...
                     <div class="col-md-12">
                        <p><b>12. </b>Seller agrees that a security deposit in the amount of  $
                           <span class="text-readonly">
                              ...
                              ?>
                              <input type="text" class="readonly" id="" name="security_deposit" value="{{$deposit_security??0}}" readonly="readonly">
                           </span>
                  ...
                  <div class="form-group">
                     <div class="col-md-12">
                        ...
                        <p><b>14.</label> ADDITIONAL PROVISIONS:</label>   
                        <textarea rows="2" type="text" class="form-control text-height" id="" name="additional_provisions">{{$savedQuestionSellerPostClosing->additional_provisions??""}}</textarea>
                        @if(count($errors->get('additional_provisions')) > 0)
                        <span class="text text-danger">{{implode('<br>', $errors->get('additional_provisions'))}}</span>
                        @endif
                     </div>
                  </div>
                  ...
                  <div class="form-group btns-green-blue">
                     <div class="col-sm-12">
                        <div class="btns-green-blue">
                            <button type="submit" class="button btn btn-blue">Next</button>
                        </div>
                     </div>
                  </div>
                  {{ html()->form()->close() }}
...
//               required: "Please fill additional provision"
//            }
//         }
//      });
