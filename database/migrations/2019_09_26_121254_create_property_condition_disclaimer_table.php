...
class CreatePropertyConditionDisclaimerTable extends Migration {
	...
	public function up()
	{
		Schema::create('property_condition_disclaimer', function(Blueprint $table)
		{
			...
			$table->string('special_assessments', 191)->nullable();
			...
			$table->string('central_air_conditioning_type', 191)->nullable();
			$table->integer('water_heater_age')->nullable();
			$table->string('water_heater_type', 191)->nullable();
			$table->string('water_supply_type', 191)->nullable();
			$table->string('sewage_disposal_type', 191)->nullable();
			$table->string('gas_supply_type', 191)->nullable();
	...
	{
		Schema::drop('property_condition_disclaimer');
	}
