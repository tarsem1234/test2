...
class ContractToolLandlordController extends Controller
{
    ...
    public function disclosuresRentContractTool($id = null)
    {
//        dd(Session::all());
        $propertyData = Session::get('PROPERTY');
    ...
    public function saveLeaseAgreement()
    {
        $offerArray = Session::get('OFFER');
...
//        $this->_forgetPropertyOffer();
    ...
    public function saveQuestionsToLandlord(LandlordQuestionnaireRequest $request)
    {
        $data  = $request->all();
//	dd($data);
        $offerArray = Session::get('OFFER');
...
//		dd($landlordQuestionnaire->partners);
    ...
    public function saveLeadBasedPaintHazardsLandlord(Request $request)
    {
...
//        dd($data);
    ...
    public function sdSummaryKeyTermsForLandlord(Request $request)
    {
        $offerSession = Session::get('OFFER');
    ...
    public function sdThankyouForReviewSummaryKeyTermsLandlord(Request $request)
    {
        $this->validate($request, [
            'agree' => 'required',
        ]);
    ...
    public function sdLeadBasedPaintHazardsDisclosureForRentByLandlord()
    {
    ...
    public function sdThankYouLandlordNecessaryForms()
    {
...
//        dd($offer);
    ...
    public function sdThankyouLeaseAgreementLandlord()
    {
        $offerData = Session::get('OFFER');
        ...
        if ($landlordDetails->rentOffer->rentSignatures->contains('user_id', $landlordDetails->user_id)) {
            ...
            if ($landlordDetails->rentOffer->rentSignatures->contains('user_id', Auth::id())) {
                ...
                if ($landlordDetails->rentOffer->tenant_signature == config('constant.offer_signature.true') && $landlordDetails->rentOffer->landlord_signature == config('constant.offer_signature.true')) {
                    $downloadBtn = TRUE;
                } else if ($landlordDetails->rentOffer->tenant_signature == config('constant.offer_signature.true') && $landlordDetails->rentOffer->landlord_signature == config('constant.offer_signature.false')) {
