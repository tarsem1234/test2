...
<div class="offers-page"> 
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div> <h4>Received From : {{!empty($offer->buyer) ? getFullName($offer->buyer):'NA'}}</h4></div>
                    ...
                    <div>
                        <table class="summary">
                            <tbody>
                                ...
                                <tr>
                                    <td><p><strong>Optional Message From Buyer :</strong> <span>{{ $offer->optional_message??"NA" }}</span></p></td>
                                </tr>
                                <tr>
                        ...
                        <div id="mymessagesviewreply-box">
                            <table class="summary">
                                <tbody>
                                    <tr>
                                        <td><p><strong>Buyer's Name : </strong> <span>{{ getFullName($offer->buyer) ??"NA" }}</span></p></td>
                                    </tr>
                                    <tr>
                        ...
                        <div  class="bottom_btns pull-right mr-top">
                            ...
                            @if ($showOfferAceeptRejectButton == TRUE && empty($offer->buyer->deleted_at)) 
...
<!--                                            <tr>
                                                <td>
                                                    <p><strong>COUNTER OFFER PRICE 1 :</strong><span class="money">{{round($offer->tentative_offer_price)??"" }} </span>
                                                        <span class="date">
