...
<div class="row">
    <div id="owl-carousel" class="owl-carousel owl-theme owl-loaded owl-drag" >
        <div class="item properties-for-sale-bg-img ">
            <img src="{{ asset('/storage/site-images/sale.jpg') }}" class="img-responsive" />
...
<div class="container explore-our-listings">
    <div class=" col-md-12 btns-green-blue">
        <a href="{{route('frontend.saleSearch')}}" class="btn btn-lg btn-green">Explore our Listings</a>
        <a href="{{route('frontend.saleCreate')}}" class="btn btn-lg btn-blue">List Your Property</a>
    </div>
</div>
    ...
    <div class="row owner-sol-offers-row">
        <div class="container">
            <div class="col-sm-12 col-xs-12  owner-sol-offers">
                <h3>Our Owner Solutions Offer</h3>
                <p>Powerful Simplicity, Confidence, and Complete Control</p>
                <div class="container bottom-para">
                    <p class="col-sm-12">We give homeowners all the resources they need to sell or rent their home for money and zero out-of-pocket fees.  We give buyers and
    ...
    <div class="container">
        ...
        <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs nav-tabs-responsive text-center" role="tablist">       
                <a class="btn btn-sm btn-main" href="#rent" role="presentation" id="rent-tab" role="tab" data-toggle="tab" aria-controls="rent" aria-expanded="true">
                    <span class="tab-text">Rent</span>
                </a>           
                <a href="#sale" class="btn btn-sm btn-main active" role="tab" id="sale-tab" data-toggle="tab" aria-controls="sale">
            ...
            <div id="myTabContent" class="tab-content">
                <div role="tabpanel" class="tab-pane fade" id="rent" aria-labelledby="rent-tab">
                    <div class="row  mx-0">
                        <?php
                        if (isset($rentProperties) && count($rentProperties) > 0) {
                            foreach ($rentProperties as $rentProperty) {
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    ...
                                    <div class="col-sm-3 col-md-4 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
                                            <h4 class="sffasd"><span class="money">{{round($rentProperty->price)??$notAvailable }}</span></h4>
                                            <p><i class="fa fa-flag"></i> {{ findState($rentProperty->state_id) }}</p>
                                            <p><i class="fa fa-square color-black" aria-hidden="true"></i> {{ $rentProperty->architechture->plot_size }}</p>
                                            <h6 class="single_fam"><i class="fa fa-home" aria-hidden="true"></i> {{ config('constant.home_type.'.$rentProperty->architechture->home_type)??"" }}</h6>
                    ...
                    <div class="row mx-0">
                        ...
                        if (isset($saleProperties) && count($saleProperties) > 0) {
                            foreach ($saleProperties as $saleProperty) {
                                ?>
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    <a href="{{route('frontend.propertyDetails',$saleProperty->id)}}">
                                        <div class="listing-image-div">
                                    ...
                                    <div class="col-sm-3 col-md-6 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
                                            <h4 class=""><span class="money">{{round($saleProperty->price)??$notAvailable }}</span></h4>
                                            <p><i class="fa fa-flag"></i> {{ findState($saleProperty->state_id) }}</p>
                                            <p><i class="fa fa-square color-black" aria-hidden="true"></i> {{ $saleProperty->architechture->plot_size??"NA" }}</p>
                    ...
                    <div class="row  mx-0">
                        ...
                        if (isset($vacationProperties) && count($vacationProperties) > 0) {
                            foreach ($vacationProperties as $vacationProperty) {
                                ?>
                                <div class="col-md-3 col-sm-6 col-xs-12 image-div">
                                    <a href="{{route('frontend.propertyDetails',$vacationProperty->id)}}">
                                        <div class="listing-image-div">
                                    ...
                                    <div class="col-sm-3 col-md-6 col-xs-12 caption main_single">
                                        <div class="property-details property-higlight">
                                            <h4><i class="fa fa-usd color-green" aria-hidden="true"></i><span class="moeny">{{ round($vacationProperty->price)?? $notAvailable }}</span></h4>
