...
<div class="container">
    <div class="row offers-page">
        <div class="col-lg-12">
            <div class=""> <h4>Offer To : {{ isset($offer->seller->business_profile->company_name) ? $offer->seller->business_profile->company_name : (isset($offer->seller->user_profile->full_name) ? $offer->seller->user_profile->full_name:"N.A.") }}</h4></div>
            <div class="" id="mymessagesviewreply-box">
                <table class="summary">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2"><p><strong>Optional Message to Seller/Buyer :</strong> <span> @if( $offer->optional_message) {{  $offer->optional_message }} @else NA @endif</span> </p></td>
                        </tr>
                        <tr>
